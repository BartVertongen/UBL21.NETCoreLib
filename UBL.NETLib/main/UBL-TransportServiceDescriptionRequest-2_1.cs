...
namespace VertSoft.ubl21.main
{
	...
	[XmlRoot("TransportServiceDescriptionRequest"
			, Namespace = "urn:oasis:names:specification:ubl:schema:xsd:TransportServiceDescriptionRequest-2", IsNullable = false)]
