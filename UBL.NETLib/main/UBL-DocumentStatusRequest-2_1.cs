...
namespace VertSoft.ubl21.main
{
	...
	[XmlTypeAttribute(Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusRequest-2")]
	[XmlRootAttribute("DocumentStatusRequest", Namespace = "urn:oasis:names:specification:ubl:schema:xsd:DocumentStatusRequest-2", IsNullable = false)]
